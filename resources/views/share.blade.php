...
<html lang="en">
    <head>
        ...
        @section('head')
            ...
            <!-- Google tag (gtag.js) -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-MQ4HC3NHG8"></script>
            <script>
                window.dataLayer = window.dataLayer || [];
                function gtag(){dataLayer.push(arguments);}
                gtag('js', new Date());

                gtag('config', 'G-MQ4HC3NHG8');
            </script>
            <!-- Meta Pixel Code -->
            <script>
    ...
    <body>
        <div class="navbar navbar-expand-md navbar-light navbar-oasis fixed-top">
            <a class="navbar-brand" href="{{route('share')}}">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{route('share')}}">About</a>
                    </li>
                    <li class="nav-item">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a class="side-btn" href="{{route('share')}}">About</a>
            <a class="side-btn" href="#features">Features</a>
        </div>
        <div class="main-banner">
            <div class="main-banner-text">
                <h1>Share and connect anonymously, and get the relief and support you need with Harmony Oasis</h1><br>
        ...
        <section id="features">
            ...
            <div class="cards">
                <div class="card" data-aos="zoom-in-right">
                    <div class="card-infos">
                        <div class="d-flex justify-content-center">
                            <h3 class="steps">Emergency Button</h3>
                        </div>
                        <p>"Meltdown and share" button, for when things feel overwhelming. Share with a trusted third party, either another person or our AI assistant, and get a feeling of relief.</p><br>
                        <div class="signup" data-page="share" data-button="first">
                ...
                <div class="card" data-aos="zoom-in-up" data-aos-delay="200">
                    <div class="card-infos">
                        <div class="d-flex justify-content-center">
                            <h3 class="steps">Rewards for Self-Care</h3>
                        </div>
                        <p>Point-based rewards system which incentivizes you to prioritize emotional health by completing tasks such as taking breaks, meditating, or just giving yourself a compliment.</p><br>
                        <div class="signup" data-page="share" data-button="second">
                            <button class="btn btn-flat btn-modal">SIGN UP</button>
                        </div>
                    </div>
                </div>
                <div class="card" data-aos="zoom-in-left" data-aos-delay="400">
                    <div class="card-infos">
                        <div class="d-flex justify-content-center">
                            <h3 class="steps">Supportive Community</h3>
                        </div>
                        <p>A community forum,  where you can connect anonymously with others navigating similar life challenges. Share, learn, and grow within a circle of support that respects and understands your cultural background.</p><br>
                        <div class="signup" data-page="share" data-button="third">
                            <button class="btn btn-flat btn-modal">SIGN UP</button>
                        </div>
                    </div>
                </div>
