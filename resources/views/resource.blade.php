...
<html lang="en">
    <head>
        ...
        @section('head')
            ...
            <!-- Google tag (gtag.js) -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-LJ98TRD8BJ"></script>
            <script>
                window.dataLayer = window.dataLayer || [];
                function gtag(){dataLayer.push(arguments);}
                gtag('js', new Date());

                gtag('config', 'G-LJ98TRD8BJ');
            </script>
            <!-- Meta Pixel Code -->
            <script>
    ...
    <body>
        <div class="navbar navbar-expand-md navbar-light navbar-oasis fixed-top">
            <a class="navbar-brand" href="{{route('resource')}}">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{route('resource')}}">About</a>
                    </li>
                    <li class="nav-item">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a class="side-btn" href="{{route('resource')}}">About</a>
            <a class="side-btn" href="#features">Features</a>
        </div>
        <div class="main-banner">
            <div class="main-banner-text">
                <h1>Safely self-diagnose and access the personalized resources you need on Harmony Oasis</h1><br>
            ...
            <div class="cards">
                <div class="card" data-aos="zoom-in-right">
                    <div class="card-infos">
                        ...
                        <div class="signup" data-page="resource" data-button="first">
                ...
                <div class="card" data-aos="zoom-in-up" data-aos-delay="200">
                    <div class="card-infos">
                        <div class="d-flex justify-content-center">
                            <h3 class="steps">Multi-Medium Resource Directory</h3>
                        </div>
                        <p>POur directory gives you access to various resources to help manage your emotional health. Directory resources come in various formats (image, text, video, audio, etc.).</p><br>
                        <div class="signup" data-page="resource" data-button="second">
                            <button class="btn btn-flat btn-modal">SIGN UP</button>
                        </div>
                    </div>
                </div>
                <div class="card" data-aos="zoom-in-left" data-aos-delay="400">
                    <div class="card-infos">
                        ...
                        <p>Building on the self-diagnosis, our platform provides you with a personalized list of resources, and anonymously matches you with peers based on profile, preferences, topics and behavior.</p><br>
                        <div class="signup" data-page="resource" data-button="third">
                            <button class="btn btn-flat btn-modal">SIGN UP</button>
                        </div>
                    </div>
                </div>
